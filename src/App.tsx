...
const islandersLogo = "/src/assets/images/islanders_logo_1782106365047.jpg";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="shrink-0">
              <img
                src={islandersLogo}
                alt="Islanders Tours and Services Logo"
                className="h-14 sm:h-16 w-auto object-contain border-2 border-black bg-white p-0.5 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] select-none"
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider mt-1 select-none">
                {t.subtitle} • ISLANDERS TOURS AND SERVICES
              </p>
            </div>
          </div>
